package com.logical.jdbc.demo.auth;
...
public class SecurityOAuth2Configuration extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory().withClient("client").secret(bCryptPasswordEncoder.encode("password"))
				...
				.authorizedGrantTypes("password", "refresh_token").autoApprove(true); // grant type
